 ...
 */
#define WR(x,val)                                  WRITE_CBUS_REG(x+offset,val)
#define WR_BITS(x,start,length,val)     WRITE_CBUS_REG_BITS(x+offset,start,length,val)
#define RD(x)                                        READ_CBUS_REG(x+offset)
#define RD_BITS(x,start,length)           READ_CBUS_REG_BITS(x+offset,start,length)
