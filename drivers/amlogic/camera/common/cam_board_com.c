...
int __init bf3a03_v4l2_probe(struct i2c_adapter *adapter)
{
    int ret = 0;
	unsigned char reg[2];   
...
int __init sp0718_v4l2_probe(struct i2c_adapter *adapter)
{
	int ret = 0;
	unsigned char reg;   
	reg = aml_i2c_get_byte_add8(adapter, 0x21, 0x02);
