...
struct aml_camera_i2c_fig_s OV5640_capture_3M_script[] = {
    {0x3035, 0x31},
    {0x3036, 0x69},
    {0x3c07, 0x07},
    {0x3820, 0x41}, // #3 ck. 0x40,
...
struct aml_camera_i2c_fig_s OV5640_capture_2M_script[] = {
    {0x3035, 0x31},
    {0x3036, 0x69},
    {0x3c07, 0x07},
    {0x3820, 0x41}, // #3 ck. 0x40,
...
static resolution_param_t  capture_resolution_array[] = {
	...
	}, 
	{
		...
		.reg_script			= OV5640_capture_2M_script,
		//.reg_script		= OV5640_preview_script,
	},{
		.frmsize			= {2048, 1536},
		...
		.reg_script			= OV5640_capture_3M_script,
	},
};
