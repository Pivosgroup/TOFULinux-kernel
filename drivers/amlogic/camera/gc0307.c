...
*
*************************************************************************/
void set_GC0307_param_exposure(struct gc0307_device *dev,enum camera_exposure_e para)//曝光调节
{
	struct i2c_client *client = v4l2_get_subdevdata(&dev->sd);
...
static int vidioc_streamon(struct file *file, void *priv, enum v4l2_buf_type i)
{
	...
	para.frame_rate = gc0307_frame_rate;//150;
	para.h_active = gc0307_h_active;
	para.v_active = gc0307_v_active;
	para.hsync_phase = 0;
	para.vsync_phase = 1;
	para.hs_bp = 0;
	para.vs_bp = 2;
	...
	printk("0307,h=%d, v=%d, frame_rate=%d\n", 
		gc0307_h_active, gc0307_v_active, gc0307_frame_rate);
