...
#define var_LNActrl_default                 0x01d9

#define ce_setFlatTH_layerA                 0x01da
#define auto_control_mpeg_clk_pol           0x01db
#define CATV_flag                           0x01dc

#define set_freq_wait_for_ifoe              0x01dd

#define far_aci_p_total_10                  0x01de
#define var_P_total_9                       0x01df
#define var_P_total_10                      0x01e0
#define half_lo_freq_7_0                    0x01e1
#define half_lo_freq_15_8                   0x01e2
#define half_lnac_lna_cap_sel               0x01e3
#define var_P_inband_half                   0x01e4
#define P_inband_half_thr                   0x01e5
#define var_P_total_half                    0x01e6

#define var_one_seg                         0x01e7

#define var_UART_RX_ready                   0x01e8
#define var_UART_RX_detect_length           0x01e9
#define var_UART_RX_detect_length_done      0x01ea
#define var_UART_status                     0x01eb
#define var_UART_realsend                   0x01ec

#define var_layer_filter_msb                0x01ed

#define var_is79                            0x01ee

#define var_end                             0x01ef
