...
Dword Demodulator_setOneSeg (
    IN  Demodulator*    demodulator,
	IN  Byte            isoneseg
){
	return(Standard_setOneSeg(demodulator, isoneseg));
}

Dword Demodulator_setLayerFilter (
    IN  Demodulator*    demodulator,
           IN  Byte            enableLayerA,
           IN  Byte            enableLayerB,
           IN  Byte            enableLayerC
){                                       
           return (Standard_setLayerFilter(demodulator, enableLayerA, enableLayerB, enableLayerC));
}
