...
int tvoutc_setmode2(tvmode_t mode)
{
	...
	switch(mode)
	{
        ...
        /*set VID2 for EncI*/
        WRITE_MPEG_REG(HHI_VIID_PLL_CNTL, 0x20000000|0x20224); //reg 0x1047
        ...
        WRITE_CBUS_REG_BITS(HHI_VIID_CLK_DIV, 0x9, 28, 4); //0x104a, select v2_clk_div2 for cts_vdac_clk[0] 
        break;
		case TVMODE_480P:
		case TVMODE_576P:
