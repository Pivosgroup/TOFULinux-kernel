...
static ssize_t dump_pmu_regs_show   (struct device *dev, struct device_attribute *attr, char *buf, int count);
static ssize_t dump_pmu_regs_store  (struct device *dev, struct device_attribute *attr, char *buf, int count);
