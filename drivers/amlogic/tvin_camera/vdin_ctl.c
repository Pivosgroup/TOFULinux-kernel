...
#if defined(CONFIG_ARCH_MESON6)
        case 0x100: // mipi
            if(port_ == TVIN_PORT_MIPI_NV21)
                format_convert = VDIN_FORMAT_CONVERT_YUV_NV21; 
            else if(port_ == TVIN_PORT_MIPI_NV12)
...
//    unsigned int offset = devp->addr_offset;
    ...
    if(write_format == 2){
        ...
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
            0, WR_HCONV_MODE_BIT, WR_HCONV_MODE_WID);
        // swap_cbcr
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
            (format_convert == VDIN_FORMAT_CONVERT_YUV_NV21)?1:0, WR_SWAP_CBCR_BIT, WR_SWAP_CBCR_WID);
        // vconv_mode
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
            0, WR_VCONV_MODE_BIT, WR_VCONV_MODE_WID);       
        //chroma canvas
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL2 + offset),
            VDIN_START_CANVAS+VDIN_START_CANVAS_CHROMA_OFFSET, WR2_CANVAS_BIT, WR2_CANVAS_WID);
    }else{
        // hconv_mode
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
            0, WR_HCONV_MODE_BIT, WR_HCONV_MODE_WID);
        // swap_cbcr
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
            0, WR_SWAP_CBCR_BIT, WR_SWAP_CBCR_WID);
        // vconv_mode
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
            0, WR_VCONV_MODE_BIT, WR_VCONV_MODE_WID);   
        //chroma canvas
        WRITE_CBUS_REG_BITS((VDIN_WR_CTRL2 + offset),
            0, WR2_CANVAS_BIT, WR2_CANVAS_WID);
    }
#endif
    // format
    WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
        write_format, WR_FMT_BIT, WR_FMT_WID);
    // canvas_id
    WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
...
{
    WRITE_CBUS_REG_BITS((VDIN_WR_CTRL + offset),
        canvas_id&0xff, WR_CANVAS_BIT, WR_CANVAS_WID);
#if defined(CONFIG_ARCH_MESON6)
    WRITE_CBUS_REG_BITS((VDIN_WR_CTRL2 + offset),
        (canvas_id>>8)&0xff, WR2_CANVAS_BIT, WR2_CANVAS_WID);
#endif
}
...
inline void get_graphic_prop(vframe_prop_t* prop, unsigned int offset)
{
    unsigned int vs_cnt_hi = 0, vs_cnt_lo = 0, pow = 0;
    unsigned int gamma[64];
    unsigned int luma_sum, chroma_sum, pixel_sum, luma_max, luma_min;

    // fetch hist info
    prop->hist.luma_sum   = READ_CBUS_REG(VDIN_HIST_SPL_VAL + offset);
    prop->hist.chroma_sum = READ_CBUS_REG(VDIN_HIST_CHROMA_SUM + offset);
    prop->hist.pixel_sum  = READ_CBUS_REG_BITS((VDIN_HIST_SPL_PIX_CNT + offset),
                                HIST_PIX_CNT_BIT,     HIST_PIX_CNT_WID    );
    pow                      = READ_CBUS_REG_BITS((VDIN_HIST_CTRL + offset),
                                HIST_POW_BIT,         HIST_POW_WID        ) + 3;
    luma_max   = READ_CBUS_REG_BITS((VDIN_HIST_MAX_MIN + offset),
                                HIST_MAX_BIT,         HIST_MAX_WID        );
    luma_min   = READ_CBUS_REG_BITS((VDIN_HIST_MAX_MIN + offset),
                                HIST_MIN_BIT,         HIST_MIN_WID        );
    prop->hist.gamma[0]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST00 + offset),
                                HIST_ON_BIN_00_BIT,   HIST_ON_BIN_00_WID  ) << pow;
    prop->hist.gamma[1]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST00 + offset),
                                HIST_ON_BIN_01_BIT,   HIST_ON_BIN_01_WID  ) << pow;
    prop->hist.gamma[2]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST01 + offset),
                                HIST_ON_BIN_02_BIT,   HIST_ON_BIN_02_WID  ) << pow;
    prop->hist.gamma[3]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST01 + offset),
                                HIST_ON_BIN_03_BIT,   HIST_ON_BIN_03_WID  ) << pow;
    prop->hist.gamma[4]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST02 + offset),
                                HIST_ON_BIN_04_BIT,   HIST_ON_BIN_04_WID  ) << pow;
    prop->hist.gamma[5]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST02 + offset),
                                HIST_ON_BIN_05_BIT,   HIST_ON_BIN_05_WID  ) << pow;
    prop->hist.gamma[6]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST03 + offset),
                                HIST_ON_BIN_06_BIT,   HIST_ON_BIN_06_WID  ) << pow;
    prop->hist.gamma[7]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST03 + offset),
                                HIST_ON_BIN_07_BIT,   HIST_ON_BIN_07_WID  ) << pow;
    prop->hist.gamma[8]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST04 + offset),
                                HIST_ON_BIN_08_BIT,   HIST_ON_BIN_08_WID  ) << pow;
    prop->hist.gamma[9]   = READ_CBUS_REG_BITS((VDIN_DNLP_HIST04 + offset),
                                HIST_ON_BIN_09_BIT,   HIST_ON_BIN_09_WID  ) << pow;
    prop->hist.gamma[10]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST05 + offset),
                                HIST_ON_BIN_10_BIT,   HIST_ON_BIN_10_WID  ) << pow;
    prop->hist.gamma[11]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST05 + offset),
                                HIST_ON_BIN_11_BIT,   HIST_ON_BIN_11_WID  ) << pow;
    prop->hist.gamma[12]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST06 + offset),
                                HIST_ON_BIN_12_BIT,   HIST_ON_BIN_12_WID  ) << pow;
    prop->hist.gamma[13]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST06 + offset),
                                HIST_ON_BIN_13_BIT,   HIST_ON_BIN_13_WID  ) << pow;
    prop->hist.gamma[14]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST07 + offset),
                                HIST_ON_BIN_14_BIT,   HIST_ON_BIN_14_WID  ) << pow;
    prop->hist.gamma[15]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST07 + offset),
                                HIST_ON_BIN_15_BIT,   HIST_ON_BIN_15_WID  ) << pow;
    prop->hist.gamma[16]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST08 + offset),
                                HIST_ON_BIN_16_BIT,   HIST_ON_BIN_16_WID  ) << pow;
    prop->hist.gamma[17]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST08 + offset),
                                HIST_ON_BIN_17_BIT,   HIST_ON_BIN_17_WID  ) << pow;
    prop->hist.gamma[18]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST09 + offset),
                                HIST_ON_BIN_18_BIT,   HIST_ON_BIN_18_WID  ) << pow;
    prop->hist.gamma[19]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST09 + offset),
                                HIST_ON_BIN_19_BIT,   HIST_ON_BIN_19_WID  ) << pow;
    prop->hist.gamma[20]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST10 + offset),
                                HIST_ON_BIN_20_BIT,   HIST_ON_BIN_20_WID  ) << pow;
    prop->hist.gamma[21]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST10 + offset),
                                HIST_ON_BIN_21_BIT,   HIST_ON_BIN_21_WID  ) << pow;
    prop->hist.gamma[22]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST11 + offset),
                                HIST_ON_BIN_22_BIT,   HIST_ON_BIN_22_WID  ) << pow;
    prop->hist.gamma[23]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST11 + offset),
                                HIST_ON_BIN_23_BIT,   HIST_ON_BIN_23_WID  ) << pow;
    prop->hist.gamma[24]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST12 + offset),
                                HIST_ON_BIN_24_BIT,   HIST_ON_BIN_24_WID  ) << pow;
    prop->hist.gamma[25]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST12 + offset),
                                HIST_ON_BIN_25_BIT,   HIST_ON_BIN_25_WID  ) << pow;
    prop->hist.gamma[26]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST13 + offset),
                                HIST_ON_BIN_26_BIT,   HIST_ON_BIN_26_WID  ) << pow;
    prop->hist.gamma[27]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST13 + offset),
                                HIST_ON_BIN_27_BIT,   HIST_ON_BIN_27_WID  ) << pow;
    prop->hist.gamma[28]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST14 + offset),
                                HIST_ON_BIN_28_BIT,   HIST_ON_BIN_28_WID  ) << pow;
    prop->hist.gamma[29]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST14 + offset),
                                HIST_ON_BIN_29_BIT,   HIST_ON_BIN_29_WID  ) << pow;
    prop->hist.gamma[30]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST15 + offset),
                                HIST_ON_BIN_30_BIT,   HIST_ON_BIN_30_WID  ) << pow;
    prop->hist.gamma[31]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST15 + offset),
                                HIST_ON_BIN_31_BIT,   HIST_ON_BIN_31_WID  ) << pow;
    prop->hist.gamma[32]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST16 + offset),
                                HIST_ON_BIN_32_BIT,   HIST_ON_BIN_32_WID  ) << pow;
    prop->hist.gamma[33]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST16 + offset),
                                HIST_ON_BIN_33_BIT,   HIST_ON_BIN_33_WID  ) << pow;
    prop->hist.gamma[34]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST17 + offset),
                                HIST_ON_BIN_34_BIT,   HIST_ON_BIN_34_WID  ) << pow;
    prop->hist.gamma[35]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST17 + offset),
                                HIST_ON_BIN_35_BIT,   HIST_ON_BIN_35_WID  ) << pow;
    prop->hist.gamma[36]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST18 + offset),
                                HIST_ON_BIN_36_BIT,   HIST_ON_BIN_36_WID  ) << pow;
    prop->hist.gamma[37]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST18 + offset),
                                HIST_ON_BIN_37_BIT,   HIST_ON_BIN_37_WID  ) << pow;
    prop->hist.gamma[38]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST19 + offset),
                                HIST_ON_BIN_38_BIT,   HIST_ON_BIN_38_WID  ) << pow;
    prop->hist.gamma[39]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST19 + offset),
                                HIST_ON_BIN_39_BIT,   HIST_ON_BIN_39_WID  ) << pow;
    prop->hist.gamma[40]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST20 + offset),
                                HIST_ON_BIN_40_BIT,   HIST_ON_BIN_40_WID  ) << pow;
    prop->hist.gamma[41]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST20 + offset),
                                HIST_ON_BIN_41_BIT,   HIST_ON_BIN_41_WID  ) << pow;
    prop->hist.gamma[42]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST21 + offset),
                                HIST_ON_BIN_42_BIT,   HIST_ON_BIN_42_WID  ) << pow;
    prop->hist.gamma[43]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST21 + offset),
                                HIST_ON_BIN_43_BIT,   HIST_ON_BIN_43_WID  ) << pow;
    prop->hist.gamma[44]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST22 + offset),
                                HIST_ON_BIN_44_BIT,   HIST_ON_BIN_44_WID  ) << pow;
    prop->hist.gamma[45]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST22 + offset),
                                HIST_ON_BIN_45_BIT,   HIST_ON_BIN_45_WID  ) << pow;
    prop->hist.gamma[46]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST23 + offset),
                                HIST_ON_BIN_46_BIT,   HIST_ON_BIN_46_WID  ) << pow;
    prop->hist.gamma[47]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST23 + offset),
                                HIST_ON_BIN_47_BIT,   HIST_ON_BIN_47_WID  ) << pow;
    prop->hist.gamma[48]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST24 + offset),
                                HIST_ON_BIN_48_BIT,   HIST_ON_BIN_48_WID  ) << pow;
    prop->hist.gamma[49]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST24 + offset),
                                HIST_ON_BIN_49_BIT,   HIST_ON_BIN_49_WID  ) << pow;
    prop->hist.gamma[50]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST25 + offset),
                                HIST_ON_BIN_50_BIT,   HIST_ON_BIN_50_WID  ) << pow;
    prop->hist.gamma[51]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST25 + offset),
                                HIST_ON_BIN_51_BIT,   HIST_ON_BIN_51_WID  ) << pow;
    prop->hist.gamma[52]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST26 + offset),
                                HIST_ON_BIN_52_BIT,   HIST_ON_BIN_52_WID  ) << pow;
    prop->hist.gamma[53]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST26 + offset),
                                HIST_ON_BIN_53_BIT,   HIST_ON_BIN_53_WID  ) << pow;
    prop->hist.gamma[54]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST27 + offset),
                                HIST_ON_BIN_54_BIT,   HIST_ON_BIN_54_WID  ) << pow;
    prop->hist.gamma[55]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST27 + offset),
                                HIST_ON_BIN_55_BIT,   HIST_ON_BIN_55_WID  ) << pow;
    prop->hist.gamma[56]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST28 + offset),
                                HIST_ON_BIN_56_BIT,   HIST_ON_BIN_56_WID  ) << pow;
    prop->hist.gamma[57]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST28 + offset),
                                HIST_ON_BIN_57_BIT,   HIST_ON_BIN_57_WID  ) << pow;
    prop->hist.gamma[58]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST29 + offset),
                                HIST_ON_BIN_58_BIT,   HIST_ON_BIN_58_WID  ) << pow;
    prop->hist.gamma[59]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST29 + offset),
                                HIST_ON_BIN_59_BIT,   HIST_ON_BIN_59_WID  ) << pow;
    prop->hist.gamma[60]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST30 + offset),
                                HIST_ON_BIN_60_BIT,   HIST_ON_BIN_60_WID  ) << pow;
    prop->hist.gamma[61]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST30 + offset),
                                HIST_ON_BIN_61_BIT,   HIST_ON_BIN_61_WID  ) << pow;
    prop->hist.gamma[62]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST31 + offset),
                             HIST_ON_BIN_62_BIT,   HIST_ON_BIN_62_WID  ) << pow;
    prop->hist.gamma[63]  = READ_CBUS_REG_BITS((VDIN_DNLP_HIST31 + offset),
                                HIST_ON_BIN_63_BIT,   HIST_ON_BIN_63_WID  ) << pow;
    return;
...
#if defined(CONFIG_ARCH_MESON6)
    // [  15]  asfifo_mipi.de_en            = 1
    // [  14]  asfifo_mipi.vs_en            = 1
    // [  13]  asfifo_mipi.hs_en            = 1
    // [  12]  asfifo_mipi.vs_inv           = 0/(positive-active, negative-active)
    // [  11]  asfifo_mipi.hs_inv           = 0/(positive-active, negative-active)
    // [  10]  asfifo_mipi.rst_on_vs        = 0
    // [    9]  asfifo_mipi.clr_ov_flag      = 0
    // [    8]  asfifo_mipi.rst              = 0
    // [    7]  asfifo_viu.de_en            = 1
    // [    6]  asfifo_viu.vs_en            = 1
    // [    5]  asfifo_viu.hs_en            = 1
    // [    4]  asfifo_viu.vs_inv           = 0/(positive-active, negative-active)
    // [    3]  asfifo_viu.hs_inv           = 0/(positive-active, negative-active)
    // [    2]  asfifo_viu.rst_on_vs        = 0
    // [    1]  asfifo_viu.clr_ov_flag      = 1
    // [    0]  asfifo_viu.rst              = 0
    WRITE_CBUS_REG((VDIN_ASFIFO_CTRL3         + offset), 0x0000e0e2);
...
#if defined(CONFIG_ARCH_MESON6)
    // [ 7: 0]       write2.chroma_canvas          = 0
    WRITE_CBUS_REG((VDIN_WR_CTRL2              + offset), VDIN_START_CANVAS+VDIN_START_CANVAS_CHROMA_OFFSET);
#endif
