 ...
 *
 * $Id: dhd_linux.c 388269 2013-02-28 19:21:57Z $
 */
...
//		memcpy(dhd->dhd_cspec.country_abbrev, "JP", WLC_CNTRY_BUF_SZ);
//		memcpy(dhd->dhd_cspec.ccode, "JP", WLC_CNTRY_BUF_SZ);
//		dhd->dhd_cspec.rev = 0;
//    }
...
#endif /* (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 27)) */
//#if defined(WL_CFG80211) // terence 20120530: fix for preinit function missed called after resume
