...
#define ATH_IOCTL_AGGREGATION_RX            (IOCTL_PHYDEV_MASK | 8)       /* Rx aggregation max */
#endif
...
typedef enum athcfg_wcmd_type{
    ...
    ATHCFG_WCMD_SET_AGGREGATION_RX   = (ATH_IOCTL_AGGREGATION_RX     | IOCTL_SET_MASK),
#endif
}athcfg_wcmd_type_t;
...
typedef union athcfg_wcmd_data{
    ...
    a_uint8_t                       aggregation_rx_percant;
#endif
} athcfg_wcmd_data_t;
...
#define d_rx_aggregation        iic_data.rx_aggregation_percent
#endif
