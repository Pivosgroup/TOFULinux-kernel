...
#define REMOTE_SW_G19_PATTERN				(0x5<<4)
...
#define REMOTE_WORK_MODE_G19       (REMOTE_SW_G19_PATTERN|REMOTE_WORK_MODE_FIQ)
...
extern irqreturn_t remote_g19_bridge_isr(int irq, void *dev_id);
...
extern void remote_g19_reprot_key(unsigned long data);
