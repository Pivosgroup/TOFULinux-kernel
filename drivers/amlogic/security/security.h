...
typedef struct security_mac_bt_s {
	u8 data[6];
} security_mac_bt_t;
...
//get chip id 
#define SECURITY_IOC_G_CI	_IOWR(SECURITY_IOC_MAGIC, 0x19, security_ci_t)

#define SECURITY_IOC_G_MAC_BT	_IOR(SECURITY_IOC_MAGIC, 0x1A, security_mac_bt_t)
#define SECURITY_IOC_B_MAC_BT	_IOW(SECURITY_IOC_MAGIC, 0x1B, security_mac_bt_t)
...
#define SECURITY_IOC_C_2RSA_FILE_BUF	_IOWR(SECURITY_IOC_MAGIC, 0x1F, signed int)
#define SECURITY_IOC_C_2RSA_FILE_UBOOT	_IOWR(SECURITY_IOC_MAGIC, 0x20, signed int)
