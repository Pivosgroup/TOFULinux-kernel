...
static struct adc_key adc_kp_key[] = {
    {KEY_PLAYPAUSE,                 "playpause", CHAN_5, 1020, 40},
    {KEY_VOLUMEDOWN,    "vol-", CHAN_4, 150, 40},
    {KEY_VOLUMEUP,          "vol+", CHAN_4, 275, 40},
    {KEY_NEXTSONG,                "nextsong", CHAN_7, -1000, 0},
    {KEY_HOMEPAGE,                "homepage", CHAN_4, 440, 40},
};
...
/* 
    .irq_gpio = PAD_GPIOE_9, 
    .en_gpio = PAD_GPIOC_4,
    .wake_gpio = PAD_GPIOC_9,
*/	
	.irq_gpio = PAD_GPIOA_2,
	.en_gpio =  PAD_GPIOAO_6,
	.wake_gpio = PAD_GPIOD_2,
...
#ifdef CONFIG_GSl3680_CAPACITIVE_TOUCHSCREEN_G17_SKYWORTH_M1701
    {
...
*/	
    aml_clr_reg32_mask(P_PAD_PULL_UP_REG4,1<<22| 1<<29|1<<21);
    gpio_set_status(PAD_GPIOA_2,gpio_status_in);
    gpio_set_status(PAD_GPIOAO_6,gpio_status_out);
    gpio_set_status(PAD_GPIOD_2,gpio_status_out);  //MAY X_26
    gpio_out(PAD_GPIOD_2,0);
    gpio_irq_set(PAD_GPIOA_2,GPIO_IRQ(6,GPIO_IRQ_RISING));
#endif
...
MACHINE_START(MESON6_G17_M1701, "Amlogic Meson 6 g17 m1701 board")
