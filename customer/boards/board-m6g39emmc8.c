...
static struct battery_parameter g39emmc8_battery = {
...
static int g39emmc8_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
    ...
    .soft_limit_to99 =  0,
    .para            =  NULL,                       // para will pass to g39emmc8_pmu_call_back
    .pmu_call_back   =  g39emmc8_pmu_call_back,
    .board_battery   = &g39emmc8_battery,
};
...
MACHINE_START(MESON6_G39EMMC8, "Amlogic Meson6 g39emmc8 customer platform")
