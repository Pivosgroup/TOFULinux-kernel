/*
 * arch/arm/mach-meson6/board-meson6-g11-t80.c
 *
...
static int g11_t80_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    ...
    .pmu_call_back   =  g11_t80_pmu_call_back,
    .board_battery   = &g11_t80_battery,
};
...
static struct meson_cs_pdata_t vcck_pdata = {
    ...
    .voltage_step_table = {
        1367000, 1342000, 1316000, 1291000,
        1265000, 1240000, 1214000, 1189000,
        1163000, 1138000, 1113000, 1087000,
        1061000, 1036000, 1010000, 985000,
    },
    .default_uV = 1240000,
};
...
{
	DBG_LINE_INFO();
    gpio_set_status(PAD_GPIOD_3,gpio_status_out);//set wifi_en gpio mode out
    if(is_on){
...
static void bt_device_init(void)
{
	...
	/* BT_RST_N */
	gpio_set_status(PAD_GPIOD_5,gpio_status_out);	
	/* BT_REG_ON */
...
static struct platform_device g11_t80_vdin1_device = {
    .name       = "vdin",
    .id         = 1,
...
MACHINE_START(MESON6_G11_T80, "Amlogic Meson6 g11 T80 customer platform")
