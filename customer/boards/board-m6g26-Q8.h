...
#ifndef __MACH_MESON6_BOARD_M6G04_H
#define __MACH_MESON6_BOARD_M6G04_H
...
#define PPMGR_MEM_SIZE               800 * 480 * 21
#else
#define PPMGR_MEM_SIZE               800 * 480 * 18
#endif
#else
...
void m6g04_set_vccx2(int power_on);
int  m6g04_lcd_init(void);

#endif // __MACH_MESON6_BOARD_M6G04_H
