...
#define BL_MIN_LEVEL    	10		//Keep this value the same as UI min-limit
...
Lcd_Config_t m6g11_e8hds_lcd_config = {
    ...
    .lcd_basic = {
        ...
        .screen_actual_width=174, //this is value for 160 dpi please set real value according to spec. 
        .screen_actual_height=104,//
    ...
    .lcd_timing = {
        ...
        .div_ctrl = 0x18813,
        .clk_ctrl = 0x31111, //[19:16]ss_ctrl, [12]pll_sel, [8]div_sel, [4]vclk_sel, [3:0]xd
