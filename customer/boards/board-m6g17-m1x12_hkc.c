...
#include "board-m6g17-m1x12_hkc.h"
...
static struct battery_parameter g17_battery = {
    ...
    .pmu_battery_rdc = 98,////150,
    .pmu_battery_cap = 5710,    ////8000,
...
//CONFIG_CAM_DEV(sp2518, sp2518_i2c, CAM_SP2518);
#endif
...
#ifdef CONFIG_GSl2682_CAPACITIVE_TOUCHSCREEN_G17_M1X12
    {
        I2C_BOARD_INFO("gslX680", 0x40),
    },
#endif

#ifdef CONFIG_GSl3680_CAPACITIVE_TOUCHSCREEN_G17_SKYWORTH_T102_HKC
    {
	I2C_BOARD_INFO("gslX680", 0x40),
    }
#endif

#ifdef CONFIG_GSl2682_CAPACITIVE_TOUCHSCREEN_G17_HKC_SKYWORTH
    {
	I2C_BOARD_INFO("gslX680", 0x40),
    }
#endif
...
//@owen start
/*adc for hp detect*/ 
	//printk("_____________get_adc_sample(6)=%d\n",get_adc_sample(6)); 
		val = HP_PLUG;
    }
   //printk("!!!!!!!!!!!!!!!!!!!!!!!!!!!_val =%d\n",val); 
//@owen end
...
MACHINE_START(MESON6_G17_M1x12, "Amlogic Meson 6 g17 M1x12 board")
