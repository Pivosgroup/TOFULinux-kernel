 ...
 */
#ifndef __MACH_MESON6_BOARD_M6G34_H
#define __MACH_MESON6_BOARD_M6G34_H
...
#define PPMGR_MEM_SIZE               (CONFIG_FB_OSD1_DEFAULT_WIDTH * (((CONFIG_FB_OSD1_DEFAULT_HEIGHT+31)>>5)<<5) * 21)
#else
#define PPMGR_MEM_SIZE               (CONFIG_FB_OSD1_DEFAULT_WIDTH * (((CONFIG_FB_OSD1_DEFAULT_HEIGHT+31)>>5)<<5) * 18)
#endif
#else
...
#endif // __MACH_MESON6_BOARD_M6G34_H
