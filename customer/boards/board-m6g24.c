...
static pinmux_item_t gc0328_pins[] = {
    {
        .reg = PINMUX_REG(9),
        .setmask = 1 << 12
    },
...
static pinmux_set_t gc0328_pinmux_set = {
    .chip_select = NULL,
    .pinmux = &gc0328_pins[0]
};

static int gc0328_init(void)
{
    pinmux_set(&gc0328_pinmux_set);
    aml_set_reg32_bits(P_HHI_GEN_CLK_CNTL, 1, 8, 5); //select XTAL as camera clock
...
static aml_plat_cam_data_t video_gc0328_data = {
    ...
    .early_suspend = gc0328_v4l2_early_suspend,
    .late_resume = gc0328_v4l2_late_resume,
...
#ifdef CONFIG_VIDEO_AMLOGIC_CAPTURE_GC0328
    {
        /*gc0328 i2c address is 0x42/0x43*/
