...
#define GT82X_XRES 800
#define GT82X_YRES 1280
...
static u8 gt82x_config[] = {
	...
	0x0F,0x00,0xFF,0xFF,0xFF,0xFF,0x13,0x09,
	0x12,0x08,0x11,0x07,0x10,0x06,0x0F,0x05,
	0x0E,0x04,0x0D,0x03,0x0C,0x02,0xFF,0xFF,
	0xFF,0xFF,0x0F,0x03,0x10,0x00,0x00,0x1C,
	0x00,0x00,0x05,0x00,0x00,0x02,0x50,0x3C,
	0x35,0x03,0x00,0x05,0x00,GT82X_XRES>>8,GT82X_XRES&0xff,GT82X_YRES>>8,
...
{
	gpio_out(PAD_GPIOE_10, 1);    // set 5640 camera power disable
...
#endif
#if defined CONFIG_VIDEO_AMLOGIC_CAPTURE_OV5640 || defined CONFIG_VIDEO_AMLOGIC_CAPTURE_OV5642
...
static int ov5642_v4l2_probe(struct i2c_adapter *adapter)
{
	int ret = 0;
	unsigned char reg[2];
	ov5640_v4l2_init();	
...
MACHINE_START(MESON6_G17_T069, "Amlogic Meson 6 g17 t069 board")
