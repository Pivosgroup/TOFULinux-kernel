...
#ifdef CONFIG_AMVIDEOCAP_OUT
#define VIDEO_CAP_MEM_SIZE      (1920*1088*3)
#else
#define VIDEO_CAP_MEM_SIZE      1
#endif
#define VIDEO_CAP_ADDR_START    U_ALIGN(PPMGR_ADDR_END)
#define VIDEO_CAP_ADDR_END      (VIDEO_CAP_ADDR_START+VIDEO_CAP_MEM_SIZE-1)
...
static struct resource meson_codec_resource[] = {
    ...
    [2] = {
        .start = VIDEO_CAP_ADDR_START,
        .end   = VIDEO_CAP_ADDR_END,
        .flags = IORESOURCE_MEM,
    },
};
