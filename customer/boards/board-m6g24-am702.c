...
#define CAM_PWR			PAD_GPIOA_25
#define CAM_RST			PAD_GPIOZ_0
#define CAM_FRONT_PWDN		PAD_GPIOE_10
#define CAM_BACK_PWDN		PAD_GPIOE_11
...
#define CONFIG_VDDAO_NORMAL_VOLTAGE 1200
...
static void nt99252_v4l2_uninit(void)
{
    ...
    gpio_out(CAM_BACK_PWDN, 1);    // set camera power disable,10
    msleep(5);
...
#endif
#if defined(CONFIG_VIDEO_AMLOGIC_CAPTURE_NT99252)
    if (nt99252_have_inited == 0)
#endif
        aml_set_reg32_bits(P_HHI_GEN_CLK_CNTL, 0, 8, 1); //close clock
}
...
static struct aml_camera_i2c_fig1_s custom_sp0a19_script[] = {  
/*	{0x14,0x11}, // h_v
	{0x26,0x01},
	{0xff,0xff}, 
*/
...
static aml_plat_cam_data_t video_sp0a19_data = {
	.name="video-sp0a19",
	.video_nr=1,//1,_GJL_   camera mirro 
	.device_init= sp0a19_v4l2_init,
	.device_uninit=sp0a19_v4l2_uninit,
	.custom_init_script = custom_sp0a19_script,
...
static struct ts_platform_data_ssd253x ts_pdata_ssd253x = {
	.irq_no 			= FT_IRQ,
	.reset_gpio_no	= GPIO_FT_RST,
	.irq_gpio_no		= GPIO_FT_IRQ,
};
#endif

#ifdef CONFIG_SSD2543_CAPACITIVE_TOUCHSCREEN
#include <linux/ssd2543.h>
#define FT_IRQ	INT_GPIO_0
#define GPIO_FT_RST  PAD_GPIOC_3
#define GPIO_FT_IRQ  PAD_GPIOA_16
static struct ts_platform_data_ssd2543 ts_pdata_ssd2543 = {
	.irq_no 			= FT_IRQ,
	.reset_gpio_no	= GPIO_FT_RST,
	.irq_gpio_no		= GPIO_FT_IRQ,
};
...
#ifdef CONFIG_FOCALTECH_5X02_CAPACITIVE_TOUCHSCREEN
#include <linux/ft5x02_ts.h>//gjl
#define GPIO_FT_RST  PAD_GPIOC_3
#define GPIO_FT_IRQ  PAD_GPIOA_16
#define FT_IRQ	INT_GPIO_0
...
static struct ft5x02_platform_data ts_pdata = {
    .irq = FT_IRQ,
//    .reset = GPIO_FT_RST,	//GJL
    .power = ts_power,
...
#ifdef CONFIG_FOCALTECH_CAPACITIVE_TOUCHSCREEN_G05_M76
#include <linux/ft5x06_ts_g05.h>
#define FT_IRQ	INT_GPIO_0

static unsigned char ft_fw[] = {
#include "board-m6g05-m76-touch.fw"
};
...
static struct i2c_board_info __initdata aml_i2c_bus_info_a[] = {
#ifdef CONFIG_VIDEO_AMLOGIC_CAPTURE_SP0a19
	{
        /*sp0a19 i2c address is 0x42/0x43*/
...
#ifdef CONFIG_SSD25XX_CAPACITIVE_TOUCHSCREEN
    {
        ...
        .platform_data = (void *)&ts_pdata_ssd253x,
    },
#endif
...
#ifdef CONFIG_SSD2543_CAPACITIVE_TOUCHSCREEN
    {
        ...
        .platform_data = (void *)&ts_pdata_ssd2543,
    },
#endif
#ifdef CONFIG_FOCALTECH_5X02_CAPACITIVE_TOUCHSCREEN
		{
			I2C_BOARD_INFO(FT5X02_NAME, 0x38),
			.irq = INT_GPIO_0,
			.platform_data = (void *)&ts_pdata,
		},
#endif
...
/*    #if defined(CONFIG_BCM4329_HW_OOB) || defined(CONFIG_BCM4329_OOB_INTR_ONLY)/* Jone add */
    gpio_set_status(PAD_GPIOX_11,gpio_status_in);
	printk("000000000000000000000000000000000000000000000");
...
static struct resource ite9133_resource[]  = {
	[0] = {
		.start = PAD_GPIOA_13,//PAD_GPIOD_8,//(GPIOD_bank_bit0_9(8)<<16)|GPIOD_bit_bit0_9(8), //reset pin
		.end   = PAD_GPIOA_13,//(GPIOD_bank_bit0_9(8)<<16)|GPIOD_bit_bit0_9(8),
		.flags = IORESOURCE_MEM,
	...
	[3] = {
		.start = 0x3c,                                 //frontend 0 demod address
		.end   = 0x3c,
		.flags = IORESOURCE_MEM,
		.name  = "frontend0_demod_addr"
	},
	[4] = {
		.start = PAD_GPIOA_12,//(GPIOA_bank_bit0_27(17)<<16)|GPIOA_bit_bit0_27(17),  //// tuner_enable
		.end   = PAD_GPIOA_12,//(GPIOA_bank_bit0_27(17)<<16)|GPIOA_bit_bit0_27(17),
		.flags = IORESOURCE_MEM,
...
static __init void meson_init_machine(void)
{
	...
	gpio_set_status(PAD_GPIOA_12, gpio_status_out);
    //mmc_lp_suspend_init();
    setup_usb_devices();
