...
static unsigned int vcck_pwm_table[MESON_CS_MAX_STEPS] = {
	0x030019, 0x030019, 0x030019, 0x030019, 
	0x0b0011, 0x0b0011, 0x0b0011, 0x0b0011, 
...
static int _key_code_list[] = {KEY_KPEQUAL, KEY_POWER};
...
#define FEC_B
   ...
   m6skt_smc_init();
    ...
    aml_clr_reg32_mask(P_AO_GPIO_O_EN_N,1<<21);//GPIO_AO 5 L NET_LED
