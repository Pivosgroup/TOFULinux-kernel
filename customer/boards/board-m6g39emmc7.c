...
static struct battery_parameter g39emmc7_battery = {
...
static int g39emmc7_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
    ...
    .soft_limit_to99 =  0,
    .para            =  NULL,                       // para will pass to g39emmc7_pmu_call_back
    .pmu_call_back   =  g39emmc7_pmu_call_back,
    .board_battery   = &g39emmc7_battery,
};
...
MACHINE_START(MESON6_G39EMMC7, "Amlogic Meson6 g39emmc7 customer platform")
