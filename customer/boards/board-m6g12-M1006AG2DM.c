...
#ifdef CONFIG_BATTERY_AUTO_CALIBRATE
static struct battery_curve axp20_exp_curve[] = {
    {3132,      0,      0},  
    {3273,      0,      0},  
    {3414,      0,      0},  
    {3555,      0,      0},             // empty ocv 
    ...
    {4012,     79,     85}, 
    {4083,     89,     94}, 
    {4153,    100,    100}              // full ocv
};
#endif /* CONFIG_BATTERY_AUTO_CALIBRATE */
...
#ifdef CONFIG_FOCALTECH_CAPACITIVE_TOUCHSCREEN_G12_ANDA_M1006
...
#endif
#if CONFIG_GSl3680_CAPACITIVE_TOUCHSCREEN_G12_ANDA_M1006A2
    {
...
static struct mtd_partition normal_partition_info[] = {
    ...
    {
        .name = "cache",
        .offset = 1352*SZ_1M+40*SZ_1M,
        .size = 256*SZ_1M,
    },
    {
        .name = "userdata",
        .offset = 1608*SZ_1M+40*SZ_1M,
        .size = 1768*SZ_1M,
    },
    {
        .name = "NFTL_Part",
...
static int modem_power_on(void)
{
	...
	axp_gpio_set_value(0, 0);	//set AXP 202 GPIO0 low ,power on
	mdelay(10);
...
static int modem_power_off(void)
{
	...
	axp_gpio_set_io(0,0);	//AXP 202 GPIO0 VCCX2 
	gpio_out(PAD_GPIOA_3,1);//GPIOA_3 = power_key
	mdelay(8);
	gpio_out(PAD_GPIOA_2,0); //GPIOA_2 = off_sleep
	mdelay(5);
...
static int modem_power_off(void)
{ 
    printk("modem power_off! \n ");  
    //gpio_out(PAD_GPIOAO_6, 0);        //GPIOAO_6
    axp_gpio_set_value(0, 0x1);
    return 0;
}
#endif
