/*
 * arch/arm/mach-meson6/board-m6g11-a1002.c
 *
...
static struct ts_platform_data ts_pdata = {
	...
	.power = ts_power,
	.screen_max_x=800,//1024,
	.screen_max_y=480,//600,
	.xpol = 0,
	.ypol = 0,
};
#endif
...
#define MG8698S_XRES 1728
#define MG8698S_YRES 960
...
{
	#include "../drivers/touchscreen/firmware/CJBS_10V1_Inch_V0.0C.mgar"
};
...
static void m6g11_a1002_set_vccx2(int power_on)
{
    if (power_on) {
        ...
        axp_gpio_set_io(1,0);	//GPIO1 VCCX2 
    }
...
static struct meson_pm_config aml_pm_pdata = {
    ...
    .ddr_clk = 0x00110820,
    .sleepcount = 128,
    .set_vccx2 = m6g11_a1002_set_vccx2,
...
MACHINE_START(MESON6_G11_A1002, "Amlogic Meson 6 g11 a1002 platform")
