...
static struct battery_parameter g38_7203_battery = {
...
static int g38_7203_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    ...
    .pmu_call_back   =  g38_7203_pmu_call_back,
    .board_battery   = &g38_7203_battery,
};
...
#ifdef CONFIG_GSl1680E_CAPACITIVE_TOUCHSCREEN_G38_T7203
    {    
...
void extern_wifi_set_enable(int is_on)
{
    ...
    if(is_on){
    gpio_out(PAD_GPIOC_8,1); //pwer on
...
MACHINE_START(MESON6_G38_7203, "Amlogic Meson6 g38_7203 customer platform")
