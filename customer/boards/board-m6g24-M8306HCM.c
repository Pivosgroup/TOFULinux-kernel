...
#include "board-m6g24-M8306HCM.h"
...
static struct battery_parameter g24_battery = {
    ...
    .pmu_battery_rdc = 82,     ////150,
    .pmu_battery_cap = 2890,    ////8000,
...
#if defined(CONFIG_FOCALTECH_CAPACITIVE_TOUCHSCREEN_G24M8306HCM) || defined(CONFIG_FOCALTECH_CAPACITIVE_TOUCHSCREEN_5302_G24M8306HCM)
...
#endif
#if defined(CONFIG_GSl2680_CAPACITIVE_TOUCHSCREEN_G24_M8306HCM) || defined(CONFIG_GSl3680_CAPACITIVE_TOUCHSCREEN_G24_M8306HCM)
    {
...
MACHINE_START(MESON6_G24_M8306HCM, "Amlogic Meson6 g24 M8306HCM customer platform")
