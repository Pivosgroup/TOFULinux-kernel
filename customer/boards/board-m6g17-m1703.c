...
static struct battery_parameter g17_battery = {
    ...
    .pmu_battery_rdc = 116,     ////150,
    .pmu_battery_cap = 3640,    ////8000,
    ...
    .pmu_suspend_chgcur = 900000,	//set suspend charging current limite
    .pmu_resume_chgcur = 500000,							//set resume charging current limite
    .pmu_shutdown_chgcur = 900000,		//set shutdown charging current limite
    .pmu_usbcur_limit = 1,
    .pmu_usbcur = 900,
#endif
    .pmu_usbvol_limit = 1,
...
static int g17_led_control(int flag)
{
	switch(flag){
...
static struct adc_key adc_kp_key[] = {
    ...
    //{KEY_NEXTSONG,                "nextsong", CHAN_7, 900, 40},
...
{
    gpio_out(PAD_GPIOE_11, 1);// set front camera power enable
...
#endif
#ifdef CONFIG_GSl2682_CAPACITIVE_TOUCHSCREEN_G17_SKYWORTH_M1703
    {
...
static struct i2c_board_info __initdata aml_i2c_bus_info_b[] = {
	...
	//added by zam for light sensor
#if (defined(CONFIG_STK220X_INT_MODE) || defined(CONFIG_STK220X_POLL_MODE))
	{
...
{
    gpio_set_status(PAD_GPIOA_2,gpio_status_in);
    gpio_irq_set(PAD_GPIOA_2,GPIO_IRQ(4,GPIO_IRQ_HIGH));
    #ifdef CONFIG_AM_WIFI
...
MACHINE_START(MESON6_G17_M1703, "Amlogic Meson 6 g17 t102 board")
