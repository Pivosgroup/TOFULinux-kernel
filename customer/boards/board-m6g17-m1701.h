 ...
 */
#ifndef __MACH_MESON6_BOARD_M6G17_M1701_H
#define __MACH_MESON6_BOARD_M6G17_M1701_H
...
#define OSD2_PANEL_PIX       (1280*720)
#define B16BpP  (2)
#define B32BpP  (4)
...
#define OSD3_MAX_MEM        U_ALIGN(OSD2_PANEL_PIX*B32BpP*DOUBLE_BUFFER)
...
#define CODEC_MEM_SIZE      U_ALIGN(64*SZ_1M)   //32
#else
...
#define PPMGR_MEM_SIZE               1280 * 1280 * 21
#else
