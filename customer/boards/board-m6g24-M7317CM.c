...
static void bf3703_v4l2_early_suspend(void)
{

}

static void bf3703_v4l2_late_resume(void)
{

}

static struct aml_camera_i2c_fig1_s bf3703_custom_init_script[] = {
    {0x1e,0x20},  //0x10 00  10 20 30 
    {0xff,0xff},
};
...
#error
    ...
    .early_suspend = bf3703_v4l2_early_suspend,
    .late_resume = bf3703_v4l2_late_resume,
...
static void bf3920_v4l2_early_suspend(void)
{

}

static void bf3920_v4l2_late_resume(void)
{
...
static aml_plat_cam_data_t video_bf3920_data = {
    ...
    .early_suspend = bf3920_v4l2_early_suspend,
    .late_resume = bf3920_v4l2_late_resume,
...
#endif
#ifdef CONFIG_FOCALTECH_5X02_CAPACITIVE_TOUCHSCREEN_M7317
...
#ifdef CONFIG_VIDEO_AMLOGIC_CAPTURE_BF3703
    {      
        I2C_BOARD_INFO("BF3703_i2c",  0x6e ),
...
#ifdef CONFIG_VIDEO_AMLOGIC_CAPTURE_BF3920
    {
           I2C_BOARD_INFO("BF3920_i2c",  0x6f ),
...
#endif
#ifdef CONFIG_GSL1680_CAPACITIVE_TOUCHSCREEN_M7317CM
    {
