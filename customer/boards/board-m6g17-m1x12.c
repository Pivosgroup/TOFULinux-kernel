...
/*adc for hp detect*/ 
	...
	if ((get_adc_sample(6)<=HP_PLUG_ADC+27)&&(get_adc_sample(6)>=HP_BUTTON_ADC+27))
	{//printk("_____________return HP_plug!!!!!!!!!!!!!!!!!!!!!!"); 
		val = HP_PLUG;
	}
    else if((get_adc_sample(6)>=HP_PLUG_ADC+27))
    {
        val = HP_UNPLUG;
    }
   //printk("!!!!!!!!!!!!!!!!!!!!!!!!!!!_val =%d\n",val); 
