 ...
 */
#ifndef __MACH_MESON6_BOARD_M6G24-86V4_H
#define __MACH_MESON6_BOARD_M6G24-86V4_H
...
//WIFI SETTING BEGIN
/////////////////////////////////////////////////
#define  KERNEL_USE_SDIO_WIFIBT               1

//For murata wifi,sdio interface
//reset & powerdown enable
#define	USB_WIFI_PWR_USEING_AXP_GPIO2	1

//AUDIOSWITCH SETTING BEGIN
#define	KERNEL_RT5631_MONO_CONTROL	1	//for emdoor signal speaker by emdoor jim.kuang 2012-06-16
#define SPEAKER_LESS_1_5DB	 1	//reduce speaker voice	by emdoor ming.huang 2012-09-29
#define HP_LESS_22_5DB 1 //reduce hp voice for play file  has noise after record

//#define EM73_USE_HI704	1
#define CAM_PWR			PAD_GPIOA_25
#define CAM_RST			PAD_GPIOZ_0
#define CAM_FRONT_PWDN		PAD_GPIOE_10//PAD_GPIOE_11
#define CAM_BACK_PWDN		PAD_GPIOE_11//PAD_GPIOE_10

/////////////////////////////////////////////////
//G-Sensor MODULE SETTING END
/////////////////////////////////////////////////
#define MULTI_SENSORS	1
#ifdef MULTI_SENSORS
enum{
	GSENSOR_TYPE_NONE = 0,
	GSENSOR_TYPE_DMT06,
	GSENSOR_TYPE_MMA7660,
	GSENSOR_TYPE_MC3210,
	GSENSOR_TYPE_MC3230,
};
#endif
//G-Sensor MODULE SETTING END
/////////////////////////////////////////////////
//Moto MODULE SETTING END
/////////////////////////////////////////////////

//Moto MODULE SETTING END
//HDMI MODULE SETTING END
/////////////////////////////////////////////////
#define HDMI_SINK_NO_EDID 1
...
//32 bytes align
		...
		#define PPMGR_MEM_SIZE               800 * 488 * 21
#else
		#define PPMGR_MEM_SIZE				 800 * 488 * 18
#endif
#else
