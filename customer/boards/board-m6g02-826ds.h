/*
 * customer/boards/board-m3g02-d8.h
 *
...
#ifndef __MACH_MESON6_BOARD_M6G02_826D_H
#define __MACH_MESON6_BOARD_M6G02_826D_H
...
#define PPMGR_MEM_SIZE               1024 * 774 * 21
#else
#define PPMGR_MEM_SIZE               1024 * 774 * 18
#endif
#else
...
void m6g02_d8_set_vccx2(int power_on);
