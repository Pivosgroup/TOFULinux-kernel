...
#endif
//#define CONFIG_BATTERY_SGRSGR263 	//动力聚能4400  kernel默认提交的是这个
#define CONFIG_BATTERY_SGRSGR302 		//环宇达4400
...
#ifdef CONFIG_BATTERY_SGRSGR302
static struct battery_parameter g24_battery = {
    .pmu_twi_id = 2,		//AXP20_I2CBUS
    .pmu_irq_id = INT_WATCHDOG,
    .pmu_twi_addr = AXP20_ADDR,
    .pmu_battery_rdc = 89,
    .pmu_battery_cap = 4196,
    .pmu_battery_technology = POWER_SUPPLY_TECHNOLOGY_LiFe,
    .pmu_battery_name = "PTI PL336078",
    .pmu_init_chgvol = 4200000,			//set initial charing target voltage
    .pmu_init_chgend_rate = 15,		//set initial charing end current	rate
...
#endif
#ifdef CONFIG_GSl1680_CAPACITIVE_TOUCHSCREEN_G12_ANDA_M802A1
    {
        I2C_BOARD_INFO("gsl1680", 0x40),
    },
#endif
#ifdef CONFIG_GSl2680_CAPACITIVE_TOUCHSCREEN_G12_ONDA_M806A2
    {
