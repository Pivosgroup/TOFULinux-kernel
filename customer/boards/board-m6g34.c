...
static struct battery_parameter g34_battery = {
    .pmu_twi_id = 2,		//AXP20_I2CBUS
    .pmu_irq_id = INT_WATCHDOG,
    .pmu_twi_addr = AXP20_ADDR,
    .pmu_battery_rdc = 94,     ////150,
    .pmu_battery_cap = 3820,    ////8000,
...
static int g34_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    ...
    .pmu_call_back   =  g34_pmu_call_back,
    .board_battery   = &g34_battery,
};
...
#ifdef CONFIG_GOODIX_GT811_D7002_CAPACITIVE_TOUCHSCREEN
...
MACHINE_START(MESON6_G34, "Amlogic Meson6 g34 customer platform")
