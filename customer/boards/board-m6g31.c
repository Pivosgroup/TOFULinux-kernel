...
static struct battery_parameter g31_battery = {
...
static int g31_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    .soft_limit_to99 =  0,
    .para            =  NULL,                       // para will pass to g31_pmu_call_back
    .pmu_call_back   =  g31_pmu_call_back,
    .board_battery   = &g31_battery,
};
...
MACHINE_START(MESON6_G31, "Amlogic Meson6 g31 customer platform")
