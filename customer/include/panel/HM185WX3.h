...
//*****************************************
#define PANEL_MODEL			"HM185WX3"
#define BITS_OPTION			1	//0:panel don't support bits option.	1:panel support 6/8bits option

#define ACITVE_AREA_WIDTH	410	//unit: mm
#define ACITVE_AREA_HEIGHT	230	//unit: mm
...
#define V_ACTIVE			768
#define H_PERIOD			1560
#define V_PERIOD			806
//#define FRAME_RATE			50
#define	LCD_CLK				78000000//(H_PERIOD * V_PERIOD * FRAME_RATE)	//unit: Hz
