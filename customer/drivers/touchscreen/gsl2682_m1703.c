...
static void gsl_load_fw(struct i2c_client *client)
{
	...
	gpio_set_status(PAD_GPIOC_5,gpio_status_in);
	gpio_set_status(PAD_GPIOC_6,gpio_status_in);
	if((gpio_get_val(PAD_GPIOC_5) == 1) &&( gpio_get_val(PAD_GPIOC_6)  == 1))
	{
		printk("++++++++++++++++++++++++++++++++++++\n++++++++++++++++++++++++\
			++++++++++++\n++++++++++++++++++\n++++++++++++++++++++\
			++++++++++\n++++++++++++++++\n++++++++++++++++++");
		#ifdef GSL2682B_COMPATIBLE
		msleep(50);
		...
		if(read_buf[2] == 0x82)
		{
			ptr_fw = GSL2682B_FW_x;
			source_len = ARRAY_SIZE(GSL2682B_FW_x);	
		}
		else
		#endif
		{
			ptr_fw = GSLX680_FW_x;
			source_len = ARRAY_SIZE(GSLX680_FW_x);
		}
	...
	else
	{
		...
		**************\n*******************\n********************");
		...
		{
			ptr_fw = GSL2682B_FW;
			source_len = ARRAY_SIZE(GSL2682B_FW);	
		}
		else
		#endif
		{
