...
#define	byd693x_I2C_RATE	200*1000   //400KHz	//Charles 12-11-16 change to 200KHz,Test OK!
...
{ 0, 0x07, 0x01, 0x00},	// Wakeup TP from Sleep mode		//Charles 12-12-10 change from 1 to 0
};
