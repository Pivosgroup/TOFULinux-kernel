...
static const char *goodix_ts_name = "gt813_827_828";
...
static s32 gtp_init_panel(struct goodix_ts_data *ts)
{
	...
	printk("%s: ts->pdata->xmax == %d ; ts->pdata->ymax == %d\n 9308", __FUNCTION__,ts->pdata->xmax,ts->pdata->ymax);
  
#if GTP_DRIVER_SEND_CFG
    u8 rd_cfg_buf[16];
    u8 cfg_info_group1[] = CTP_CFG_GROUP_9308;   //CTP_CFG_GROUP_9308
...
*/
//		ts->use_irq = 0;
//		free_irq(/*ts->client->irq*/GTP_INT_IRQ,ts);
//    }
