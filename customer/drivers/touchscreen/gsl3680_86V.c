...
//#include "../../boards/hcn_board_config.h"

#if defined(CONFIG_MACH_MESON6_G33_HC710K) || defined(CONFIG_MACH_MESON6_G33_HC714K) || defined(CONFIG_MACH_MESON6_G33_HC713K)
#include "amlogic_gslX680_480x800.h"
#elif defined(CONFIG_MACH_MESON6_G33_HC710K_HD) || defined(CONFIG_MACH_MESON6_G33_HC715K)
#include "amlogic_gslX680_600x1024.h"
#elif (defined(CONFIG_MACH_MESON6_G33_HC902K) || defined(CONFIG_MACH_MESON6_G33_HC902KB) || defined(CONFIG_MACH_MESON6_G33_HC902K_8723)) && !defined(CONFIG_MACH_MESON6_G39_HC807)
#include "rockchip_gslX680_9.7_30.h"
#elif defined(CONFIG_MACH_MESON6_G33_HC1005KB) || defined(CONFIG_MACH_MESON6_G33_HC1005K) || defined(CONFIG_MACH_MESON6_G33_HC1005K_8723)
#include "amlogic_gslX680_hc.h"
#elif defined(CONFIG_MACH_MESON6_G33_HC908K_8723_HD) || defined(CONFIG_MACH_MESON6_G33_HC908KB) || defined(CONFIG_MACH_MESON6_G33_HC908K_8723)
#include "amlogic_gslX680_mid908_1024x600.h"
#elif defined(CONFIG_MACH_MESON6_G39_HC807)//Must at the last, or it will be a logic erro
	#ifdef shenghexiang_807
	#include "gsl3680_hc807_shenghexiang.h"
	#else
	#include "gsl3680_hc807.h"
#endif
#endif
...
#define GSLX680_I2C_NAME 	"gsl3680"
...
static void judge_chip_type(struct i2c_client *client)
{
	...
	printk("[Tomy] gsl_ts_read %d\n", read_buf[2]);
	if(0x36 == read_buf[2])
	{
		chip_type = CHIP_3680B;   //0x3680b;
		is_noid_version = 1;
	}
	else
	{
		chip_type = CHIP_3680A;    //00x3680a;
		is_noid_version = 0;
	}
}
#endif
...
static void report_data(struct gsl_ts *ts, u16 x, u16 y, u8 pressure, u8 id)
{
	...
	#if defined(CONFIG_MACH_MESON6_G39_HC807) && (defined(CONFIG_MACH_MESON6_G33_HC902K) || defined(CONFIG_MACH_MESON6_G33_HC902KB) || defined(CONFIG_MACH_MESON6_G33_HC902K_8723))
	x = SCREEN_MAX_X - x;
	y = SCREEN_MAX_Y - y;
	#endif
