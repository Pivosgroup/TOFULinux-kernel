...
#ifdef  CONFIG_MESON_L2CC_OPTIMIZE
	aux_ctrl = ((1<<L2X0_AUX_CTRL_INSTR_PREFETCH_SHIFT) | (1<<L2X0_AUX_CTRL_DATA_PREFETCH_SHIFT) |
      										 ...
      										 (1<<L2X0_AUX_CTRL_HIGH_PRIORITY_SO_DEVICE_SHIFT) | (1<<0 | (1<<L2X0_AUX_CTRL_EARLY_BRESP_SHIFT)));
#else
	aux_ctrl = ((1<<L2X0_AUX_CTRL_INSTR_PREFETCH_SHIFT) | (1<<L2X0_AUX_CTRL_DATA_PREFETCH_SHIFT) |
     										 (1<<L2X0_AUX_CTRL_NS_INT_CTRL_SHIFT) | (1<<L2X0_AUX_CTRL_NS_LOCKDOWN_SHIFT) |
      										 (1<<L2X0_AUX_CTRL_SHARE_OVERRIDE_SHIFT) | (1<<L2X0_AUX_CTRL_SHARE_INVALID_SHIFT) |
      ...
      //aux_ctrl = 0x7C470001;
#ifdef  CONFIG_MESON_TRUSTZONE
		meson_smc1(MESON_MON_L2X0_AUXCTRL_INDEX, aux_ctrl);
		meson_smc1(MESON_MON_L2X0_CTRL_INDEX, 0x1);
#endif  	  
		l2x0_init(l2x0_base, aux_ctrl, ~0);
...
#ifdef CONFIG_MESON_TRUSTZONE
	    meson_smc1(MESON_MON_L2X0_PREFETCH_INDEX, prefetch);
#endif	
