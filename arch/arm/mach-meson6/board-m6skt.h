...
#define VDIN1_ADDR_START    (U_ALIGN(VDIN_ADDR_END))
#define VDIN1_ADDR_END      (VDIN1_ADDR_START + VDIN1_MEM_SIZE - 1)
#define VM_ADDR_START       U_ALIGN(VDIN1_ADDR_END)
#else
...
/**********MPI configuration*******************/
#if defined(CONFIG_AMLOGIC_MIPI)
#define MIPI_SIZE           (SZ_1M*32)
#define MIPI_ADDR_START     U_ALIGN(VM_ADDR_END)
#define MIPI_ADDR_END       (MIPI_SIZE + MIPI_ADDR_START - 1)
#define DI_ADDR_START       U_ALIGN(MIPI_ADDR_END)
#else
...
#endif // __MACH_MESON6_BOARD_SKT_H
